...
public class CameraVerificationActivity extends BaseActivity implements
    ...
    private Runnable mTimeOut = new Runnable() {
        public void run() {
            CameraVerificationActivity.this.storeRusult(false);
...
//          };
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width,
        ...
        try {
            ...
            Toast.makeText(CameraVerificationActivity.this, R.string.text_fail,
                    Toast.LENGTH_SHORT).show();
            storeRusult(false);
            finish();
            return;
