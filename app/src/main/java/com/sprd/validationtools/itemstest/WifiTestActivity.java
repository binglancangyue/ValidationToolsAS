            ...
            public void wifiStateChange(int newState) {
                switch (newState) {
                    case WifiManager.WIFI_STATE_ENABLED:
                        tvWifiState.setText(R.string.wifi_state_on);
                        break;
                    case WifiManager.WIFI_STATE_DISABLED:
                        tvWifiState.setText(R.string.wifi_state_off);
                        break;
                    case WifiManager.WIFI_STATE_DISABLING:
                        tvWifiState.setText(R.string.wifi_state_closing);
                        break;
                    case WifiManager.WIFI_STATE_ENABLING:
                        tvWifiState.setText(R.string.wifi_state_opeing);
                        break;
                    case WifiManager.WIFI_STATE_UNKNOWN:
                    default:
                        tvWifiState.setText(R.string.wifi_state_unknown);
                        // do nothing
                        break;
