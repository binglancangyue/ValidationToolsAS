...
public class SIMCardTestActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("SIMCardTestActivity", "onCreate phoneCount="+phoneCount+",mSimReadyCount="+mSimReadyCount);
        if (phoneCount >= mSimReadyCount && mSimReadyCount > 0) {
    ...
    private List<String> getResultList(int simId) {
        ...
        Log.d("tag", "getResultList: simId " + simId);
        if (simId == 0) {
            return null;
        }
