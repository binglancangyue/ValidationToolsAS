...
public class ValidationToolsMainActivity extends Activity implements
    ...
    private final static int UNIT_TEST = 0;
    private final static int FULL_TEST = 1;
    ...
    private boolean mUserAllItemInFullTest = Const.isBoardISharkL210c10();
    /*@}*/
    /*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListItemString = new String[]{
                ...
                this.getString(R.string.title_finish)
        };
    ...
    private void closeCamera() {
        Intent intent = new Intent("com.sprd.validationtools.action.release_camera");
